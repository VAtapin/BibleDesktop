...
Версия плана: 0.3  
Дата: 2026-06-19  
Статус: создан Laravel/Vue/Filament foundation, базовый канон, API справочников/главы, legacy metadata importer, первый импорт RST стихов, Strong-токенов и cross references
...
1. Расширить Filament для переводов, модулей и legacy mapping.
2. Подготовить полноценный reader flow на реальных данных.
