...
* `bible:legacy:report-skipped-verses` показывает причины skipped legacy verses и группирует их по библиотеке/книге/главе; текущий отчёт: 1127 `missing_canonical_chapter`, из них 859 в `L376_LOP`.
