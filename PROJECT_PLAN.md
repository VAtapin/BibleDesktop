...
Версия плана: 0.3  
Дата: 2026-06-19  
Статус: создан Laravel/Vue/Filament foundation, базовый канон, API справочников/главы, legacy metadata importer и первый импорт RST стихов
...
3. Расширить Filament для переводов, модулей и legacy mapping.
4. Подготовить полноценный reader flow на реальных данных.
