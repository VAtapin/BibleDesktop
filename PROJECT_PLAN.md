...
Версия плана: 0.3  
Дата: 2026-06-19  
Статус: создан Laravel/Vue/Filament foundation, базовый канон, API справочников/главы, legacy metadata importer, первый импорт RST стихов и Strong-токенов
...
2. Расширить Filament для переводов, модулей и legacy mapping.
3. Подготовить полноценный reader flow на реальных данных.
